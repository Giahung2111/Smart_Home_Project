...
aio_feed_fan_1 = os.environ.get('ADAFRUIT_AIO_FEED_FAN1')
aio_feed_door_1 = os.environ.get('ADAFRUIT_AIO_FEED_DOOR1')
...
client.on_connect = connected(client, aio_feed_fan_1)
client.on_connect = connected(client, aio_feed_door_1)
